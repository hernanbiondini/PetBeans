 ...
 * MascotaSola.java
 *
 * Created on 11-oct-2012, 10:11:37
 */
package view;
 ...
 * @author admin
 */
public class MascotaSola extends javax.swing.JDialog {

    /**
     * Creates new form MascotaSola
     */
    public MascotaSola(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public MascotaSola(java.awt.Frame parent, boolean modal, Mascota m, int id) {
        super(parent, modal);
        initComponents();
        this.jLabel1.setText(m.getNombre());
        this.jLabel8.setText(m.getNumeroChip());
        this.jLabel3.setText(m.getRaza());
        this.jLabel2.setText(m.getEspecie());
        this.jLabel4.setText(m.getSexo());
        this.jLabel5.setText(m.getTamaño());
        this.jLabel6.setText(m.getColor());
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Numero de chip:");
        jLabel17.setName("jLabel17"); // NOI18N

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel18.setText("Señas particulares:");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/imagenes/close_16.png"))); // NOI18N
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MascotaSola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                MascotaSola dialog = new MascotaSola(new javax.swing.JFrame(), true);
